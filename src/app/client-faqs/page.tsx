    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col justify-between selection:bg-amber-500 selection:text-black">
      ...
      <main className="max-w-4xl w-full mx-auto px-6 py-12 flex-grow">
        <div className="bg-gray-900/40 border border-gray-850 p-8 sm:p-12 rounded-3xl backdrop-blur-sm shadow-2xl space-y-6">
          <div className="space-y-2 border-b border-gray-850 pb-4">
          ...
          {loading ? (
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html:
                  data?.content ||
                  '<h2>Client FAQ</h2><p><b>Q: How do I book an appointment?</b></p><p>A: Select a provider, pick your service and time slot, then confirm.</p><p><b>Q: How can I cancel or reschedule?</b></p><p>A: Go to My Bookings in your profile to reschedule or cancel.</p>'
              }}
            />
          )}
        </div>
