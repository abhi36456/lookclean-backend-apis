          ...
          {loading ? (
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html:
                  data?.content ||
                  '<h2>Provider FAQ</h2><p><b>Q: How do I receive booking notifications?</b></p><p>A: Notifications are sent via push notifications and SMS.</p><p><b>Q: How do I set my schedule?</b></p><p>A: Configure your working hours under Schedule Settings.</p>'
              }}
            />
          )}
        </div>
